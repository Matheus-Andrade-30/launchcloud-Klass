...
export function seedDatabase(
  ...
  const students = [
    new User(
      'u-s1',
      'Lucas Oliveira',
      'lucas.oliveira@aluno.klass.edu',
      'student',
      new Date('2024-02-10'),
    ),
    new User(
    ...
    new User(
      'u-s4',
      'Juliana Ferreira',
      'juliana.ferreira@aluno.klass.edu',
      'student',
      new Date('2024-02-13'),
    ),
    new User(
    ...
    new User(
      'u-s8',
      'Camila Martins',
      'camila.martins@aluno.klass.edu',
      'student',
      new Date('2024-02-17'),
    ),
  ];
