...
* **Requisito:** O backend hospedado na AWS, utilizando EC2 ou Elastic Beanstalk, deve garantir uma disponibilidade de 99,9% e ser capaz de suportar picos de acesso simultâneo.
